...
import { PARENT_ADMIN_LAYOUT_STATIC } from "@/config/admin/parent-admin-layout-static"
...
export function ParentAdminLayoutProvider({
  children,
}: {
  children: ReactNode
}) {
  ...
  useAdminDocumentTitle({
    ...
    titleFallback: "HUB Parent Admin",
    descriptionFallback: "Cong quan tri cho he thong HUB Parent",
  })
