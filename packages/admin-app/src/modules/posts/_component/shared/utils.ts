...
} from "@workspace/admin-app/lib"
import { uploadAdminImage } from "@workspace/admin-app/lib/admin-upload"
import type { StoreSyncSdk } from "@workspace/api-client"
import type { EditorParagraphNodeShape, EditorStateShape } from "../shared/types"

export function uploadPostImage(api: StoreSyncSdk, file: File): Promise<string> {
  return uploadAdminImage(api, file, {
    folderPath: "posts",
