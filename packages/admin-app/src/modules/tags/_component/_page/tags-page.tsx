...
import { getTagColumns } from "../_table/columns"
import { buildTagTree, buildTagsFilterQuery, toFilterQuery } from "../shared/utils"
import {
          ...
          <TabsContent value="trash" className="mt-0 space-y-4">
            {trashQuery.error ? (
              ...
              <TagsTrashTable
                ...
                columns={
                  trashColumns as import("@tanstack/react-table").ColumnDef<TagTreeRow>[]
                }
