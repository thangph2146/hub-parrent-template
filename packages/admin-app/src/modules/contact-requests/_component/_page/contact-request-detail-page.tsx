...
import { useContactRequestDetail } from "@workspace/admin-app/hooks/queries"
import { useUpdateContactRequest } from "../_query"
...
function ContactRequestDetailPageInner() {
  ...
  const crudNav = useAdminModuleNavigation("contact-requests")
