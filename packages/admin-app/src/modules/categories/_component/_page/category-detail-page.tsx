...
import { useAdminAuth as useAuth, useAdminModuleNavigation, useAdminModulePath, useAdminApi } from "@workspace/admin-app/runtime"
import {
  PERMISSION_CODES,
  canUserAccess,
  formatDateTime,
...
import { useCategoryDetailQuery } from "../_query"
