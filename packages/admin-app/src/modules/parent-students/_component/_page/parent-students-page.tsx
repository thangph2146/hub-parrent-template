...
import { useAdminApi, useAdminAuth as useAuth } from "@workspace/admin-app/runtime"
import {
...
import { ParentStudentTable } from "../_table/parent-student-table"
import { useReviewParentStudentMutation } from "../_query/use-parent-students-queries"
import { getParentStudentsColumns } from "../_table/columns"
...
function AdminParentStudentsPageInner() {
  ...
  const canApprove = user
    ? canUserAccess(user, PERMISSION_CODES.STUDENTS_UPDATE) ||
  ...
  const reviewMutation = useReviewParentStudentMutation(() =>
  ...
  const purgeRows = useCallback(
    ...
    [queryClient, api.parentStudents]
  )
