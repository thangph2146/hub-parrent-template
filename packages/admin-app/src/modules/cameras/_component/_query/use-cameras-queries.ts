...
import type { CameraDetail, CameraRow } from "../shared/types"
...
export function useCameraDetailQuery(api: StoreSyncSdk, id: string) {
  return useQuery({
    ...adminDetailQueryOptions(
...
export function useCamerasTrashQuery({
  api,
  trashPage,
  trashPageSize,
  debouncedTrashQ,
