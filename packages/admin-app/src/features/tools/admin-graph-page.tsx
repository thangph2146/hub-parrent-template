...
import { MAIN_ADMIN_GRAPH_CONFIG } from "./graph-page.main-config"
import type { AdminGraphPageConfig } from "./graph-page.types"

export type { AdminGraphPageConfig } from "./graph-page.types"
