...
> **Sinh tự động:** `2026-06-19T01:42:38.729Z` — nhóm file **cùng boilerplate** (re-export AUTO-GENERATED, `AdminRouteLoading`, v.v.).
...
|----------|---------|--------|
| `index.ts` | 140 | — |
| `page.tsx` | 108 | CRUD page — logic trong `packages/admin-app` |
