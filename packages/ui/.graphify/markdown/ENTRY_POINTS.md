# Điểm vào (entry) — packages/ui (Graphify)

> **Sinh tự động:** `2026-06-13T21:25:57.519Z` — bootstrap, module Nest, route Next, file AUTO-GENERATED (đọc header).
...
## Next App Router (`page` / `layout` / `route`) — 1 file
