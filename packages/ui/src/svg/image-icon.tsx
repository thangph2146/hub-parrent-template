...
export function ImageIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 40 48" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M2 6a4 4 0 0 1 4-4h10v14H2V6z" fill="#0891B2" />
      <path d="M16 2l12 12v28a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V16h14V2z" fill="#fff" />
      <path d="M16 2l12 12" stroke="#D0D5DD" strokeWidth="2" />
      <circle cx="12" cy="24" r="3" fill="#0891B2" opacity="0.3" />
      <path d="M6 36l6-8 4 5 3-4 5 7" stroke="#0891B2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
