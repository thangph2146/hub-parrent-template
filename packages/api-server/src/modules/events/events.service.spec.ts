/**
 * BaseEventsService unit tests — sinh bởi generate-unified-service-specs.cjs.
 */
import { EntityManager } from '@mikro-orm/core';
import { BaseEventsService } from './events.service';

class TestEventsService extends BaseEventsService {
...
describe('BaseEventsService', () => {
  ...
  beforeEach(() => {
    ...
    service = new TestEventsService(em);
  });
