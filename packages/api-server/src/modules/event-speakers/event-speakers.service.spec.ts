/**
 * BaseEventSpeakersService unit tests — sinh bởi generate-unified-service-specs.cjs.
 */
import { EntityManager } from '@mikro-orm/core';
import { BaseEventSpeakersService } from './event-speakers.service';

class TestEventSpeakersService extends BaseEventSpeakersService {
...
describe('BaseEventSpeakersService', () => {
  let service: TestEventSpeakersService;
  ...
  beforeEach(() => {
    ...
    service = new TestEventSpeakersService(em);
  });
