/**
 * BasePageContentsService unit tests — sinh bởi generate-unified-service-specs.cjs.
 */
import { EntityManager } from '@mikro-orm/core';
import { BasePageContentsService } from './page-contents.service';

class TestPageContentsService extends BasePageContentsService {
...
describe('BasePageContentsService', () => {
  let service: TestPageContentsService;
  ...
  beforeEach(() => {
    ...
    service = new TestPageContentsService(em);
  });
