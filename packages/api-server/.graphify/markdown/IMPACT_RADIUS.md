...
> **Sinh tự động:** `2026-06-12T14:20:21.405Z` từ `../snapshot/graph.json` — file **in-degree cao** = nhiều nơi import; sửa cần kiểm tra downstream.
...
|------|-------------|-------------------------|
| `src/data-test/fixture.ts` | 98 | `src/bases/base-crud.controller.spec.ts`, `src/common/apply-column-filters.spec.ts`, `src/common/bulk-actions.spec.ts`, `src/data-test/fake-em.spec.ts`, `src/data-test/fake-em.ts`, `src/data-test/fixture.spec.ts` |
| `src/data-test/fake-em.ts` | 50 | `src/common/apply-column-filters.spec.ts`, `src/common/bulk-actions.spec.ts`, `src/data-test/fake-em.spec.ts`, `src/modules/academic-years/academic-year.service.integration.spec.ts`, `src/modules/accounts/account.service.integration.spec.ts`, `src/modules/admission-results/admission-result.service.integration.spec.ts` |
| `src/common/entity-id.ts` | 20 | `src/common/bulk-actions.ts`, `src/common/entity-id.spec.ts`, `src/common/index.ts`, `src/common/resolve-relation-filters.ts`, `src/modules/accounts/accounts-admin.service.ts`, `src/modules/comments/comments-admin.service.ts` |
| `src/common/pagination.ts` | 15 | `src/common/index.ts`, `src/common/pagination.spec.ts`, `src/common/parse-list-query.ts`, `src/modules/comments/comments-admin.service.ts`, `src/modules/event-checkins/event-checkins-admin.service.ts`, `src/modules/event-registrations/event-registrations-admin.service.ts` |
| `src/common/date-utils.ts` | 11 | `src/common/index.ts`, `src/modules/accounts/accounts-admin.service.ts`, `src/modules/comments/comments-admin.service.ts`, `src/modules/event-checkins/event-checkins-admin.service.ts`, `src/modules/event-registrations/event-registrations-admin.service.ts`, `src/modules/event-speakers/event-speakers-admin.service.ts` |
| `src/common/bulk-actions.ts` | 7 | `src/common/bulk-actions.spec.ts`, `src/common/index.ts`, `src/modules/event-checkins/event-checkins-admin.service.ts`, `src/modules/event-registrations/event-registrations-admin.service.ts`, `src/modules/event-speakers/event-speakers-admin.service.ts`, `src/modules/events/events-admin.service.ts` |
...
| `src/modules/accounts/account.service.ts` | 6 | `src/modules/accounts/account.controller.ts`, `src/modules/accounts/account.module.ts`, `src/modules/accounts/account.service.integration.spec.ts`, `src/modules/accounts/account.service.spec.ts`, `src/modules/accounts/accounts.module.ts`, `src/modules/accounts/index.ts` |
| `src/modules/auth/auth.service.ts` | 6 | `src/modules/auth/auth-admin.controller.ts`, `src/modules/auth/auth.module.ts`, `src/modules/auth/auth.service.spec.ts`, `src/modules/auth/index.ts`, `src/modules/auth/public-auth.controller.ts`, `src/modules/public/public-auth.service.ts` |
...
| `src/modules/events/event.service.ts` | 6 | `src/modules/events/event.controller.ts`, `src/modules/events/event.module.ts`, `src/modules/events/event.service.integration.spec.ts`, `src/modules/events/event.service.spec.ts`, `src/modules/events/events.module.ts`, `src/modules/events/index.ts` |
...
| `src/modules/notifications/notification.service.ts` | 6 | `src/modules/notifications/index.ts`, `src/modules/notifications/notification.controller.ts`, `src/modules/notifications/notification.module.ts`, `src/modules/notifications/notification.service.integration.spec.ts`, `src/modules/notifications/notification.service.spec.ts`, `src/modules/notifications/notifications.module.ts` |
...
| `src/modules/posts/posts.service.ts` | 6 | `src/modules/posts/index.ts`, `src/modules/posts/posts.controller.ts`, `src/modules/posts/posts.module.ts`, `src/modules/posts/posts.service.integration.spec.ts`, `src/modules/posts/posts.service.spec.ts`, `src/modules/posts/posts.types.ts` |
...
- `src/common/entity-id.ts` — 20 importer
