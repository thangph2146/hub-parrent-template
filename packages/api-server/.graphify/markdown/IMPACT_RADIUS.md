...
> **Sinh tự động:** `2026-06-19T01:42:38.825Z` từ `../snapshot/graph.json` — file **in-degree cao** = nhiều nơi import; sửa cần kiểm tra downstream.
...
| `src/common/apply-column-filters.ts` | 10 | `src/common/apply-column-filters.spec.ts`, `src/common/index.ts`, `src/modules/events/events-column-filters.ts`, `src/modules/events/events.service.ts`, `src/modules/orders/order-column-filters.ts`, `src/modules/orders/order.service.ts` |
...
| `src/common/commerce/product-types.ts` | 6 | `src/common/commerce/gift-rules.ts`, `src/common/commerce/product-units.ts`, `src/common/commerce/unit-pricing.ts`, `src/modules/orders/order-checkout.ts`, `src/modules/orders/order.service.ts`, `src/modules/products/product.service.ts` |
...
| `src/common/column-filter-builders.ts` | 4 | `src/modules/events/events-column-filters.ts`, `src/modules/orders/order-column-filters.ts`, `src/modules/page-contents/page-contents-column-filters.ts`, `src/modules/parent-students/parent-student-column-filters.ts` |
...
| `src/common/commerce/product-units.ts` | 3 | `src/common/commerce/gift-rules.ts`, `src/modules/orders/order-checkout.ts`, `src/modules/products/product.service.ts` |
...
- `src/common/apply-column-filters.ts` — 10 importer
- `src/common/date-utils.ts` — 10 importer
- `src/common/bulk-actions.ts` — 7 importer
- `src/common/commerce/product-types.ts` — 6 importer
- `src/common/column-filter-builders.ts` — 4 importer
- `src/common/parse-list-query.ts` — 4 importer
- `src/common/commerce/product-units.ts` — 3 importer
