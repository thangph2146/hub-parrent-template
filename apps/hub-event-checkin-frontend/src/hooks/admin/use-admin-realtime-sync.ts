...
} from "@/lib/admin/admin-socket"
import { queryPrefixesForAdminResource } from "@/lib/admin/admin-realtime-query-map"
...
function invalidateRoleUpsert(
  ...
  if (id) {
    void queryClient.invalidateQueries({ queryKey: ["rbac", "detail", id] })
  }
