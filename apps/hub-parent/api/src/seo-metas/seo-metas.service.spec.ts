...
describe('SeoMetasService', () => {
  let service: SeoMetasService;
  let em: Partial<EntityManager>;

  // Mock entity dựa trên row thật từ fixture
  const mockEntity: Record<string, unknown> = {
    id: 1,
    ...{"id":1,"page":"__site__","title":"Hệ thống Sự kiện HUB - Đăng ký và check-in","description":"Đăng ký tham dự sự kiện, nhận mã QR và check-in/check-out nhanh tại Trường Đại học Ngân hàng TP.HCM.","keywords":"hub sự kiện, check-in, đăng ký sự kiện, qr check-in","ogTitle":"Hệ thống Sự kiện HUB","ogDescription":"Đăng ký sự kiện, quản lý tham dự và check-in trực tuyến.","ogImage":"https://fileserver2.hub.edu.vn/IMAGES/2025/12/16/20251216103027-101020.png","status":1,"createdAt":null,"updatedAt":null,
    deletedAt: null,
  ...
  beforeEach(async () => {
    ...
    service = module.get<SeoMetasService>(SeoMetasService);
  });
