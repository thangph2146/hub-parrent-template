...
describe('PageContentsService', () => {
  ...
  const mockEntity: Record<string, unknown> = {
    id: 1,
    ...{"id":1,"pageKey":"thac-si","sectionKey":"admission-section","content":"{\"type\":\"thac-si-admission-section\",\"title\":\"Điều Kiện Xét Tuyển\",\"description\":null,\"items\":[{\"heading\":\"Phương thức tuyển sinh\",\"points\":[\"Xét tuyển theo điều kiện đầu vào và kết quả thi đầu vào.\"]},{\"heading\":\"Điều kiện dự tuyển\",\"points\":[\"Tốt nghiệp đại học chính quy đúng ngành hoặc gần ngành. Ngoại ngữ Bậc 3 (CEFR B1).\"]},{\"heading\":\"Hồ sơ dự tuyển\",\"points\":[\"Don dăng ký, bằng đại họ,
    deletedAt: null,
