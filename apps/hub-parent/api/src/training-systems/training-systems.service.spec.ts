...
/**
 * TrainingSystemsService Unit Tests — binding OOP extends @workspace/api-server BaseCrudService.
 */
...
describe('TrainingSystemsService', () => {
  let service: TrainingSystemsService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<TrainingSystemsService>(TrainingSystemsService);
  });
