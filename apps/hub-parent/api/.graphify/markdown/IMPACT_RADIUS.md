...
> **Sinh tự động:** `2026-06-19T01:42:38.476Z` từ `../snapshot/graph.json` — file **in-degree cao** = nhiều nơi import; sửa cần kiểm tra downstream.
...
|------|-------------|-------------------------|
| `src/config/constants.ts` | 81 | `src/academic-years/academic-years.controller.ts`, `src/accounts/accounts.controller.ts`, `src/admission-results/admission-results.controller.ts`, `src/auth/auth-admin.controller.ts`, `src/auth/auth.controller.ts`, `src/cameras/cameras.controller.ts` |
...
| `src/common/crud/crud-apply-column-filters.ts` | 12 | `src/common/admin/filter-configs.ts`, `src/common/crud/base-crud.service.ts`, `src/common/crud/base-standard-admin-crud.service.ts`, `src/common/crud/crud-apply-column-filters.spec.ts`, `src/common/module-bases/events/events-column-filters.ts`, `src/common/module-bases/events/events.service.ts` |
...
| `src/entities/product.entity.ts` | 10 | `src/common/commerce/gift-rules.spec.ts`, `src/common/commerce/product-units.spec.ts`, `src/common/gift-rules.ts`, `src/common/product-units.ts`, `src/mikro-orm/orm-entities.ts`, `src/orders/order-checkout.spec.ts` |
...
- `src/common/crud/crud-apply-column-filters.ts` — 12 importer
...
- `src/common/api-response.ts` — 6 importer
- `src/common/crud/crud.types.ts` — 6 importer
...
- `src/entities/product.entity.ts` — 10 importer
