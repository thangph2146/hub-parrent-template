...
import { CHECKIN_ADMIN_LAYOUT_STATIC } from "@/config/admin/checkin-admin-layout-static"
...
export function CheckinAdminLayoutProvider({
  children,
}: {
  children: ReactNode
}) {
  ...
  useAdminDocumentTitle({
    ...
    titleFallback: "Quản lý check-in",
    descriptionFallback: "Quản lý sự kiện và check-in HUB",
  })
