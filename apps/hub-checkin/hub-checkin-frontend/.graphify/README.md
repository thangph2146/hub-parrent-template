# Graphify — `apps/hub-checkin/hub-checkin-frontend`

Package **@hub-checkin/frontend**. Thư mục `.graphify/` giữ **snapshot** (`snapshot/`) và **Markdown cho AI** (`markdown/`).

## File trong thư mục này

| File / Thư mục | Mục đích |
|----------------|----------|
| `snapshot/graph.json` | Đồ thị node/link (`node script-system/graphify/graphify-update.cjs apps/hub-checkin/hub-checkin-frontend`) |
