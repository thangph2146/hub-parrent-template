# Bán kính ảnh hưởng import — apps/hub-checkin/api (Graphify)

> **Sinh tự động:** `2026-06-19T01:42:38.558Z` từ `../snapshot/graph.json` — file **in-degree cao** = nhiều nơi import; sửa cần kiểm tra downstream.
...
|------|-------------|-------------------------|
| `src/config/constants.ts` | 80 | `src/academic-years/academic-years.controller.ts`, `src/accounts/accounts.controller.ts`, `src/admission-results/admission-results.controller.ts`, `src/auth/auth.controller.ts`, `src/cameras/cameras.controller.ts`, `src/carts/carts.controller.ts` |
...
- `src/common/api-response.ts` — 5 importer
