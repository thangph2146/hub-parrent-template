...
- **context.generatedAt:** 2026-06-09T04:49:52.615Z
...
| `package.json` | config | — | — | — |
| `src/app/academic-years/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/academic-years/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/academic-years/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/cameras/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/cameras/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/cameras/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/categories/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/categories/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/categories/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/contact-requests/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/courses/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/courses/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/courses/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/departments/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/departments/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/departments/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/events/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/events/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/file-storage/_component/_table/file-storage-picker-table.tsx` | tsx | yes | FileStoragePickerTableProps, FileStoragePickerTable | src/app/file-storage/_component/file-storage-empty.tsx, src/app/file-storage/_component/types.ts |
...
| `src/app/file-storage/_component/_table/index.ts` | ts | no | FileStorageTable, FileStoragePickerTable | src/app/file-storage/_component/_table/file-storage-table.tsx, src/app/file-storage/_component/_table/file-storage-picker-table.tsx |
| `src/app/file-storage/_component/columns-picker.tsx` | tsx | yes | FileStoragePickerColumnsProps, getFileStoragePickerColumns | src/lib/format-admin-datetime.ts, src/app/file-storage/_component/types.ts, src/app/file-storage/_component/utils.ts |
...
| `src/app/file-storage/_component/file-storage-picker-panel.tsx` | tsx | yes | FileStoragePickerPanelProps, FileStoragePickerPanel | src/lib/admin-storage-picker-adapters.ts, src/lib/build-product-storage-picker-config.ts, src/app/products/_component/product-image-storage.ts |
...
| `src/app/guides/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/guides/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/locations/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/locations/[id]/loading.tsx` | loading | no | Loading |  |
| `src/app/locations/[id]/page.tsx` | page | yes | LocationDetailPage | src/lib/admin-navigation.ts, src/providers/auth-provider.tsx, src/lib/api.ts, src/app/locations/_component |
...
| `src/app/locations/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/majors/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/majors/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/majors/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/orders/[id]/edit/page.tsx` | page | yes | OrderEditPage | src/lib/admin-navigation.ts, src/providers/auth-provider.tsx, src/lib/api.ts, src/hooks/use-admin-mutation.ts, src/app/orders/_component |
...
| `src/app/orders/_component/columns.tsx` | tsx | yes | getOrderColumns | src/app/orders/_component/order-row-actions.tsx, src/app/orders/_component/order-status-cell.tsx, src/app/orders/_component/types.ts |
| `src/app/orders/_component/index.ts` | ts | no |  | src/app/orders/_component/types.ts, src/app/orders/_component/columns.tsx, src/app/orders/_component/order-status-cell.tsx, src/app/orders/_component/order-row-actions.tsx, src/app/orders/_component/u |
| `src/app/orders/_component/order-row-actions.tsx` | tsx | yes | OrderRowActionsProps, OrderRowActions, orderActionsColumnMeta | src/app/orders/_component/types.ts |
| `src/app/orders/_component/order-status-cell.tsx` | tsx | yes | OrderStatusCellProps, OrderStatusCell | src/app/orders/_component/types.ts |
| `src/app/orders/_component/types.ts` | ts | no | OrderRow, mapOrderRow, ORDER_STATUSES, ORDER_STATUS_LABELS |  |
...
| `src/app/orders/page.tsx` | page | yes | OrdersPage | src/lib/admin-navigation.ts, src/hooks/use-debounced-value.ts, src/providers/auth-provider.tsx, src/lib/api.ts, src/hooks/use-admin-mutation.ts, src/app/orders/_component |
...
| `src/app/posts/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/products/_component/product-catalog-picker-dialog.tsx` | tsx | yes | ProductCatalogPickerDialogProps, ProductCatalogPickerDialog, firstProductImage | src/lib/api.ts, src/app/products/_component/use-products-queries.ts, src/app/products/_component/types.ts |
...
| `src/app/products/_component/product-image-storage.ts` | ts | no | PRODUCT_IMAGE_PARENT_LABEL, PRODUCT_IMAGE_PARENT_SLUG, ProductImageUploadInput, ProductImageUploadContext, resolveProductImageSlug, buildProductImageUploadContext, resolveProductImageFolderNav, folder | src/lib/admin-uploads.ts, src/app/file-storage/_component/utils.ts, src/app/file-storage/_component/storage-upload-policy.ts |
| `src/app/products/_component/product-unit-gifts-field.tsx` | tsx | yes | hasSingleGiftData, hasGiftsData, ProductUnitGiftsField | src/app/products/_component/types.ts |
| `src/app/products/_component/product-unit-variants-field.tsx` | tsx | yes | ProductUnitVariantsField | src/lib/storage-image-picker-dialog.tsx, src/app/products/_component/types.ts, src/app/products/_component/product-image-storage.ts, src/app/products/_component/product-catalog-picker-dialog.tsx, src/ |
| `src/app/products/_component/products-table.tsx` | tsx | yes | ProductsTable | src/app/products/_component/types.ts |
| `src/app/products/_component/types.ts` | ts | no | ProductRow, mapProductRow, ProductUnitGiftFormRow, ProductUnitFormRow, EMPTY_GIFT_ROW, ProductFormValues, EMPTY_UNIT_ROW, parseImageUrls, formatImageUrls |  |
...
| `src/app/promo-codes/[id]/edit/page.tsx` | page | yes | EditPromoPage | src/lib/admin-navigation.ts, src/lib/api.ts, src/hooks/use-admin-mutation.ts, src/app/promo-codes/_component |
| `src/app/promo-codes/[id]/page.tsx` | page | yes | PromoDetailPage | src/lib/admin-navigation.ts, src/providers/auth-provider.tsx, src/lib/api.ts, src/app/promo-codes/_component |
| `src/app/promo-codes/_component/columns.tsx` | tsx | yes | getPromoColumns | src/lib/admin-row-action-handlers.ts, src/app/promo-codes/_component/types.ts |
| `src/app/promo-codes/_component/index.ts` | ts | no |  | src/app/promo-codes/_component/types.ts, src/app/promo-codes/_component/columns.tsx, src/app/promo-codes/_component/use-promo-queries.ts, src/app/promo-codes/_component/promo-form.tsx |
...
| `src/app/promo-codes/_component/types.ts` | ts | no | PromoRow, mapPromoRow |  |
| `src/app/promo-codes/_component/use-promo-queries.ts` | ts | no | promoDetailQueryKey, prefetchPromoDetail, usePromoDetailQuery, usePromoListQuery | src/lib/admin-detail-query.ts, src/app/promo-codes/_component/types.ts |
...
| `src/app/promo-codes/page.tsx` | page | yes | PromoCodesPage | src/lib/admin-navigation.ts, src/hooks/use-debounced-value.ts, src/providers/auth-provider.tsx, src/lib/api.ts, src/lib/admin-row-action-handlers.ts, src/hooks/use-admin-mutation.ts, src/app/promo-cod |
...
| `src/app/screens/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/screens/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/screens/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/seo-metas/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/seo-metas/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/seo-metas/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/settings/_component/constants.ts` | ts | no | SITE_SEO_PAGE_KEY, SettingsTabId |  |
| `src/app/settings/_component/index.ts` | ts | no | SITE_SEO_PAGE_KEY, extractSettingValue, SETTINGS_DISPLAY_PRESETS, SETTINGS_SEO_GLOBAL_PRESETS, getSettingsDisplayPreset, getSettingsSeoGlobalPreset, SettingsQuickPresets, SettingsCombinedCopyButton | src/app/settings/_component/constants.ts, src/app/settings/_component/utils.ts, src/app/settings/_component/settings-combined-copy-panel.tsx |
| `src/app/settings/_component/settings-combined-copy-panel.tsx` | tsx | yes | SettingsDisplayCopyValues, SettingsSeoGlobalCopyValues, SettingsCombinedCopyButton | src/app/settings/_component/constants.ts, src/app/settings/_component/settings-document-head-preview.ts |
| `src/app/settings/_component/settings-document-head-preview.ts` | ts | no | resolveSettingsDocumentHeadPreview |  |
| `src/app/settings/_component/settings-tab-skeletons.tsx` | tsx | yes | SettingsDisplayTabSkeleton, SettingsSeoGlobalTabSkeleton |  |
| `src/app/settings/_component/utils.ts` | ts | no | extractSettingValue |  |
| `src/app/settings/page.tsx` | page | yes | SettingsPage | src/lib/api.ts, src/providers/auth-provider.tsx, src/hooks/use-admin-mutation.ts, src/app/settings/_component, src/app/settings/_component/settings-tab-skeletons.tsx |
| `src/app/speakers/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/speakers/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/speakers/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/staff/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/staff/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/staff/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/tags/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/tags/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/tags/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/templates/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/templates/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/templates/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/training-levels/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/training-levels/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/training-levels/new/loading.tsx` | loading | no | Loading |  |
...
| `src/app/training-systems/[id]/edit/loading.tsx` | loading | no | Loading |  |
...
| `src/app/training-systems/[id]/loading.tsx` | loading | no | Loading |  |
...
| `src/app/training-systems/new/loading.tsx` | loading | no | Loading |  |
...
| `src/features/auth/auth-api.ts` | ts | no | fetchGoogleOAuthConfig, toAdminSessionUser, registerAccount, submitRegisterRequest |  |
...
| `src/lib/admin-detail-query.ts` | ts | no | adminDetailQueryOptions, prefetchAdminDetailQuery |  |
...
| `src/lib/admin-storage-picker-adapters.ts` | ts | no | createAdminStoragePickerAdapters | src/lib/api.ts |
...
| `src/lib/build-product-storage-picker-config.ts` | ts | no | buildProductStorageFolderScope, buildProductStorageUploadConfig | src/app/products/_component/product-image-storage.ts, src/lib/admin-upload.ts |
...
| `src/lib/storage-image-picker-dialog.tsx` | tsx | yes | StorageImagePickerDialog | src/app/products/_component/product-image-storage.ts, src/lib/admin-storage-picker-adapters.ts, src/lib/build-product-storage-picker-config.ts |
