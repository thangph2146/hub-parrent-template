...
> **Sinh tự động:** `2026-06-07T08:18:41.941Z` từ `../snapshot/graph.json` — giúp AI nắm **quy mô** và **điểm nóng import** mà không mở full graph.
...
| `src/app/settings/_component/settings-seo-pages-section.tsx` | 9 |
...
|------|------------------|
| `src/lib/api.ts` | 122 |
| `src/lib/admin-navigation.ts` | 78 |
| `src/hooks/use-admin-mutation.ts` | 66 |
| `src/components/admin-route-loading.tsx` | 57 |
| `src/providers/auth-provider.tsx` | 53 |
| `src/lib/admin-row-action-handlers.ts` | 36 |
