...
export function getRealmDefaultGroupIds(realm: StorageRealm): StorageExtensionGroupId[] {
...
export function getRealmExtensionGroups(realm: StorageRealm): StorageExtensionGroup[] {
