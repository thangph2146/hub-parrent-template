...
function NewCameraPageInner() {
  ...
  return (<AdminPageSection><CameraFormShell form={form} onSubmit={h} submitting={mut.isPending} editingId={null} onBack={() => router.push("/cameras")} onReset={() => form.reset()} /></AdminPageSection>);
}
