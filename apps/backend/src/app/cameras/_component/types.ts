...
export const cameraFormSchema = z.object({ name: z.string().min(1, "Tên camera không được để trống"), code: z.string().optional(), linkedEventId: z.string().optional(), ipAddress: z.string().optional(), port: z.coerce.number().optional(), username: z.string().optional(), password: z.string().optional(), status: z.coerce.number(), });
