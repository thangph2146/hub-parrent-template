...
function TrainingSystemsPageInner() {
  ...
  const listFilterParams = useMemo(
    () => buildAdminFilterQuery(columnFilters, COMMON_FILTER_MAPPINGS.trainingSystems),
    [columnFilters]
  );

  const trashFilterParams = useMemo(
    () => buildAdminFilterQuery(trashColumnFilters, COMMON_FILTER_MAPPINGS.trainingSystems),
    [trashColumnFilters]
  );
