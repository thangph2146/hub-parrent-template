...
function NewScreenPageInner() {
  ...
  return (<AdminPageSection><ScreenFormShell form={form} onSubmit={h} submitting={mut.isPending} editingId={null} cameraOptions={cameraOptions} templateOptions={templateOptions} onBack={() => router.push("/screens")} onReset={() => form.reset()} /></AdminPageSection>);
}
