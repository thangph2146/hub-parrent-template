          ...
          <div className="space-y-6 lg:col-span-2">
            <Card className="overflow-visible border border-border/70 shadow-sm">
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  Nội dung phong phú cho bài viết (hỗ trợ rich text).
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div>
            <Card className="sticky top-2 max-h-[calc(100vh-6rem)] overflow-y-auto border border-border/70 shadow-sm">
              ...
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  Ảnh đại diện cho preview chia sẻ và danh sách bài viết.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Controller
              ...
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  Tiêu đề, slug và mô tả ngắn — ảnh hưởng trực tiếp tới SEO.
                </CardDescription>
              </CardHeader>
              ...
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  Trạng thái hiển thị và thời điểm phát hành bài viết.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <Controller
              ...
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  Gắn danh mục và thẻ để bài viết dễ tìm hơn.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <Controller
