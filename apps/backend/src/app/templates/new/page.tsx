...
function NewTemplatePageInner() {
  ...
  return (<AdminPageSection><TemplateFormShell form={form} onSubmit={h} submitting={mut.isPending} editingId={null} onBack={() => router.push("/templates")} onReset={() => form.reset()} /></AdminPageSection>);
}
