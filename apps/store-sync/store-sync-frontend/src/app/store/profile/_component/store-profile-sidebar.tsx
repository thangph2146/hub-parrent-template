...
export function StoreProfileSidebar({
  profile,
  sessionRole,
  currentPassword,
  newPassword,
    ...
    <div className="space-y-6">
      <FieldSet variant="section">
        <FieldSectionLegend
          ...
          description="Thông tin tài khoản đại lý trên hệ thống."
        />
      ...
      <FieldSet variant="section">
        <FieldSectionLegend
          icon={KeyRound}
          title="Đổi mật khẩu"
          description="Đặt lại mật khẩu cho phiên đăng nhập cửa hàng. Mật khẩu mới cần từ 6 ký tự trở lên."
        />
        <FieldSetContent variant="section" className="space-y-5 pt-0">
          <Field>
            <FieldLabel htmlFor="store-current-pw">Mật khẩu hiện tại</FieldLabel>
            <FieldContent>
              <Input
                id="store-current-pw"
                type="password"
          ...
          <Field>
            <FieldLabel htmlFor="store-new-pw">Mật khẩu mới</FieldLabel>
            <FieldContent>
              <Input
                id="store-new-pw"
                type="password"
          ...
          <Field>
            <FieldLabel htmlFor="store-confirm-pw">
