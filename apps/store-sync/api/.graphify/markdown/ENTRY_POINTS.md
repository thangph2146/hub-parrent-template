...
> **Sinh tự động:** `2026-06-13T10:59:09.126Z` — bootstrap, module Nest, route Next, file AUTO-GENERATED (đọc header).
...
## Nest modules (`*.module.ts`) — 49 file
...
- … và 9 file khác (xem `FOLDER_TREE.md`)

## Controllers (`*.controller.ts`) — 52 file
