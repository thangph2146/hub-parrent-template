...
> **Sinh tự động:** `2026-06-19T01:42:38.642Z` — bootstrap, module Nest, route Next, file AUTO-GENERATED (đọc header).
...
## Controllers (`*.controller.ts`) — 102 file
...
## AUTO-GENERATED (không sửa tay) — 19 file
