# Graphify — `apps/store-sync/api`

Package **@store-sync/api**. Thư mục `.graphify/` giữ **snapshot** (`snapshot/`) và **Markdown cho AI** (`markdown/`).

## File trong thư mục này

| File / Thư mục | Mục đích |
|----------------|----------|
| `snapshot/graph.json` | Đồ thị node/link (`node script-system/graphify/graphify-update.cjs apps/store-sync/api`) |
