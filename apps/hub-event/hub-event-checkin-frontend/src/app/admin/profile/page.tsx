...
import { patchAdminSessionProfile } from "@/lib/admin/auth-session"
import {
  AdminListPageHeader,
  AdminPageGuard,
  AdminPageSection,
...
function AdminProfilePageInner() {
  ...
  const handleUploadAvatar = async (file: File) => {
    ...
    try {
      const { uploadAdminImage } = await import("@/lib/admin/admin-upload")
  ...
  return (
    <AdminPageSection>
      <AdminListPageHeader
        ...
        subtitle="Cập nhật tên, liên hệ, địa chỉ làm việc và mật khẩu đăng nhập BTC / quản trị sự kiện."
      />
