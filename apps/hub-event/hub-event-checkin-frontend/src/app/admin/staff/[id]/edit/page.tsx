...
import { useRbacCatalog, useStaffProfile } from "@/hooks/admin/queries"
...
import { canEditProtectedAdminUser } from "@/config/admin/protected-admin"
...
export default function EditStaffPage() {
  return (
    <AdminPageGuard permission={PERMISSION_CODES.USERS_UPDATE}>
      <EditStaffPageInner />
    </AdminPageGuard>
  )
}
