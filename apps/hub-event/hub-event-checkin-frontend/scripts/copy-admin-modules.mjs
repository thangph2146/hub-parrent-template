...
const backendApp = path.resolve(appRoot, "../../../main/backend/src/app")
...
// Types
const typesSrc = path.resolve(appRoot, "../../../main/backend/src/types/dashboard.ts")
...
const scanRoots = [
  path.join(appRoot, "src/app/admin"),
