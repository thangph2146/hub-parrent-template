...
/**
 * TrainingLevelsService Unit Tests — binding OOP extends @workspace/api-server BaseCrudService.
 */
...
describe('TrainingLevelsService', () => {
  let service: TrainingLevelsService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<TrainingLevelsService>(TrainingLevelsService);
  });
