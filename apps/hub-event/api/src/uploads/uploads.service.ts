...
import { BaseUploadsAdminService, UPLOADS_BULK_DELETE_MAX_PATHS } from '@workspace/api-server/modules/uploads';
import { appConfig } from '../config/app.config';
import { StorageFile } from '../entities/storage-file.entity';
import { User } from '../entities/user.entity';

export type { ImageItemDto, FolderItemDto, FolderNodeDto, ListImagesResult, ListFoldersResult, BulkMoveFilesResult, ReorganizeDateFoldersResult, ImportArchiveResult, ExportArchiveResult, UploadsBulkDeleteResult } from '@workspace/api-server/modules/uploads';
