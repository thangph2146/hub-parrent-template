...
- **context.generatedAt:** 2026-06-13T10:52:22.437Z
...
|------|------|--------|---------|---------|
| `package.json` | config | — | — | — |
| `src/accounts/accounts.controller.ts` | ts | no | AccountsController | src/uploads/uploads.service.ts, src/accounts/accounts.service.ts |
...
| `src/auth/auth.module.ts` | ts | no | AuthModule | src/auth/auth.service.ts, src/auth/auth.controller.ts |
...
| `src/cameras/cameras.controller.ts` | ts | no | CamerasController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/cameras/cameras.service.ts |
...
| `src/categories/categories.controller.ts` | ts | no | CategoriesController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/categories/categories.service.ts |
...
| `src/comments/comments.controller.ts` | ts | no | CommentsController | src/comments/comments.service.ts |
...
| `src/dashboard/dashboard.controller.ts` | ts | no | DashboardController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/dashboard/dashboard.service.ts |
...
| `src/event-checkins/event-checkins.controller.ts` | ts | no | EventCheckinsController | src/event-checkins/event-checkins.service.ts |
...
| `src/event-checkouts/event-checkouts.controller.ts` | ts | no | EventCheckoutsController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/event-checkouts/event-checkouts.service.ts |
...
| `src/event-registrations/event-registrations.controller.ts` | ts | no | EventRegistrationsController | src/event-registrations/event-registration-attendance.service.ts, src/event-registrations/event-registrations.service.ts |
...
| `src/event-speakers/event-speakers.controller.ts` | ts | no | EventSpeakersController | src/event-speakers/event-speakers.service.ts |
...
| `src/events/events.controller.ts` | ts | no | EventsController | src/events/events.service.ts |
...
| `src/face-data/face-data.controller.ts` | ts | no | FaceDataController | src/face-data/face-data.service.ts |
...
| `src/hanet/hanet-webhook.controller.ts` | ts | no | HanetWebhookController | src/hanet/hanet-webhook.service.ts |
...
| `src/locations/locations.controller.ts` | ts | no | LocationsController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/locations/locations.service.ts |
...
| `src/notifications/notifications.controller.ts` | ts | no | NotificationsController | src/notifications/notifications.service.ts |
...
| `src/page-contents/page-contents.controller.ts` | ts | no | PageContentsController | src/page-contents/page-contents.service.ts |
...
| `src/posts/posts.controller.ts` | ts | no | PostsController | src/posts/posts.service.ts |
...
| `src/roles/roles.controller.ts` | ts | no | RolesController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/roles/roles.service.ts |
...
| `src/screens/screens.controller.ts` | ts | no | ScreensController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/screens/screens.service.ts |
...
| `src/seo-metas/seo-metas.controller.ts` | ts | no | SeoMetasController | src/seo-metas/seo-metas.service.ts |
...
| `src/sessions/sessions.controller.ts` | ts | no | SessionsController | src/notifications/notifications.service.ts, src/socket/socket.gateway.ts, src/sessions/sessions.service.ts |
...
| `src/settings/settings.controller.ts` | ts | no | SettingsController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/settings/settings.service.ts |
...
| `src/speakers/speakers.controller.ts` | ts | no | SpeakersController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/speakers/speakers.service.ts |
...
| `src/tags/tags.controller.ts` | ts | no | TagsController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/tags/tags.service.ts |
...
| `src/templates/templates.controller.ts` | ts | no | TemplatesController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/templates/templates.service.ts |
...
| `src/uploads/uploads.controller.ts` | ts | no | UploadsController | src/uploads/uploads.service.ts |
...
| `src/users/users.controller.ts` | ts | no | UsersController | src/common/permissions.decorator.ts, src/config/permissions.ts, src/config/constants.ts, src/users/users.service.ts |
