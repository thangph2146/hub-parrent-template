...
describe('UploadsService', () => {
  ...
  const mockEntity: Record<string, unknown> = {
    ...
    ...{
      id: 1,
      relativePath:
        'images/avatars/1_z5499589779405-29f2b3d4ddf8615f7f2efdc44331cbba_1781145229631.webp',
      uploadedByUserId: 1,
      createdAt: '2026-06-11T02:33:49.000Z',
      updatedAt: '2026-06-11T02:33:49.000Z',
    },
    deletedAt: null,
