...
describe('EventsService', () => {
  ...
  const mockEntity: Record<string, unknown> = {
    id: 1,
    ...{"id":1,"title":"Thông báo tuyển sinh trình độ Tiến sĩ năm 2026","slug":"demo-thong-bao-tuyen-sinh-trinh-do-tien-si-nam-2026","poster":"{\"url\":\"https://tuyensinh.hub.edu.vn/api/admin/uploads/serve/images/2026/05/06/TSTS_1778059805572.jpg\"}","description":"Sự kiện demo được tạo từ bài viết «Thông báo tuyển sinh trình độ Tiến sĩ năm 2026» — phục vụ kiểm thử đăng ký và check-in HUB Events.","content":"{\"root\":{\"children\":[{\"children\":[{\"detail\":0,\"format\":0,\"mode\":\"normal\",\"style,
    deletedAt: null,
