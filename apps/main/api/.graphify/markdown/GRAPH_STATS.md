...
> **Sinh tự động:** `2026-06-19T01:42:38.386Z` từ `../snapshot/graph.json` — giúp AI nắm **quy mô** và **điểm nóng import** mà không mở full graph.
...
| `src/common/crud/crud-apply-column-filters.ts` | 11 |
