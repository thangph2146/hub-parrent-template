...
> **Sinh tự động:** `2026-06-12T13:00:06.583Z` từ `../snapshot/graph.json` — giúp AI nắm **quy mô** và **điểm nóng import** mà không mở full graph.
...
| `src/system/system.service.ts` | 21 |
